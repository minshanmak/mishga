        ...
        <div className="container hero-grid">
          <div className="hero-copy reveal">
            ...
            <div className="hero-actions">
              <Link href="/contact" className="btn btn-gold">Start Your Project <i className="fa-solid fa-arrow-right"></i></Link>
              <Link href="/portfolio" className="btn btn-outline">View Portfolio <i className="fa-solid fa-play"></i></Link>
            </div>
